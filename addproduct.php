...
<body class="bg-dark">
    <form class="form w-50 mt-4 mx-auto p-3 bg-light rounded-2" action="productuser.php" method="GET">
        ...
        <input class="form-control p-1 mt-2 border border-success p-2" type="text" placeholder="Enter Product_Image" name="product_image">
