...
<body>
    <form class="form w-50 mt-5 mx-auto p-3 bg-light rounded-2" action="editproduct.php" method="POST">
        ...
        <input value="<?php echo $user["availability"]?>" class="form-control p-1 mt-2" type="text" placeholder="Enter Address" name="availability">
